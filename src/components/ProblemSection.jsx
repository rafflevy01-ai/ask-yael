        ...
        <div id="problem-sticky">
          ...
          <div id="panels-track">
            ...
            <div
              ...
              <h2 style={{ fontFamily: "'DM Sans', sans-serif", fontWeight: 300, fontSize: "clamp(1rem, 2.4vw, 1.6rem)", color: "#000", letterSpacing: "-0.4px", textAlign: "center", margin: 0, whiteSpace: "nowrap" }}>
