        ...
        <div id="problem-sticky">
          ...
          <div id="panels-track">
            ...
            <div
              ...
              <h2 style={{ fontFamily: "'DM Sans', sans-serif", fontWeight: 300, fontSize: "36px", color: "#000", letterSpacing: "-0.72px", textAlign: "center", maxWidth: "900px", margin: 0, whiteSpace: "nowrap" }}>
