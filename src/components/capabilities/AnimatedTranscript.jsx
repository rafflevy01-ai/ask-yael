    ...
    <div style={{ display: "flex", flexDirection: "column", height: "100%" }}>
      ...
      <div style={{
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
          <span style={{
            width: "8px", height: "8px", borderRadius: "50%", background: "#73C2FB",
      ...
      <div style={{
        ...
        {LANGS.map((l) => (
          <span key={l.key} style={{
            ...
            background: conv.lang === l.key ? "#73C2FB" : "transparent",
...
function WaveformBars() {
  return (
    <div style={{ display: "flex", alignItems: "flex-end", gap: "1.5px", height: "14px" }}>
      {[0,1,2,3].map((i) => (
        <span key={i} style={{
          width: "2px", height: "100%", background: "#73C2FB", borderRadius: "1px",
