...
const STEP_STYLES = [
  { icon: Phone, bg: "#FCEBEB", border: "#F09595", iconColor: "#A32D2D" },
  { icon: AlertTriangle, bg: "#FDF3E0", border: "#FAC775", iconColor: "#8A5A00" },
  { icon: ArrowLeftRight, bg: "#EEF2FF", border: "#A5B4FC", iconColor: "#3730A3" },
  { icon: Check, bg: "#EAF3DE", border: "#97C459", iconColor: "#27500A" },
];
...
export default function DeescalationTransfer() {
  const { t } = useLanguage();
  const STEPS = STEP_STYLES.map((s, i) => ({ ...s, label: t.caps.deescSteps[i] }));
